<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="book.aspx.cs" Inherits="AdsClient.book" %>
...
<div class="row">
    <div class="col-md-2">
         <div class="sidenav">
             ...
             <asp:HyperLink ID="HyperLink2" runat="server">Book</asp:HyperLink>
        ...
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                <div class="card-heading">
                    <h2 class="title text-dark">Post Ads for Book</h2>
                </div>
                ...
                <div class="card-footer">
                    <asp:Button ID="Button1" runat="server" Text="Button" class="btn btn--radius-2 btn--blue-2" OnClick="Button1_Click1" OnClientClick="return confirm('Are you  you want to delete?')"/>
