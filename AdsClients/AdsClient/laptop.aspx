<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="laptop.aspx.cs" Inherits="AdsClient.laptop" %>
        ...
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                <div class="card-heading">
                    <h2 class="title text-dark">Post Ads for Laptop</h2>
                </div>
                <form method="POST" runat="server">
                 <div class="card-body">
                    ...
                    <div class="form-row">
                            ...
                            <div class="value">
                                <asp:DropDownList ID="dpitem" runat="server">
                     ...
                     <div class="form-row">
                            ...
                            <div class="value">
                                <asp:TextBox ID="txtmodel" class="input--style-6" runat="server"></asp:TextBox>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <asp:TextBox ID="txtcolor" runat="server" class="input--style-6"></asp:TextBox>
                ...
                <div class="card-footer">
                    <asp:Button ID="btnlaptop"  runat="server" Text="Add" class="btn btn--radius-2 btn--blue-2" OnClick="Button1_Click1"  OnClientClick="return confirm('Are you Sure to Add?')" />
