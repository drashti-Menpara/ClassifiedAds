...
<div class="row">
    <div class="col-md-2">
         <div class="sidenav">
             ...
             <asp:HyperLink ID="HyperLink4" runat="server" href="Myads.aspx">MyAds</asp:HyperLink>
             <asp:HyperLink ID="HyperLink1" runat="server">Car</asp:HyperLink>
             <asp:HyperLink ID="HyperLink2" runat="server" href="book.aspx">Book</asp:HyperLink>
             <asp:HyperLink ID="HyperLink3" runat="server" href="laptop.aspx">Electronics</asp:HyperLink>
        ...
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                <div class="card-heading">
                    <h2 class="title text-dark">Post Ads for Car</h2>
                </div>
                ...
                <div class="card-footer">
                        ...
                        {%>
                             ...
                             <asp:Button ID="Button2" runat="server" Text="Update" class="btn btn--radius-2 btn--blue-2" OnClick="btn_Update" OnClientClick="return confirm('Are you sure you want to Update?')" />
                           
                       
                        <%} else{ %>
                             <asp:Button ID="Button1" runat="server" Text="Add" class="btn btn--radius-2 btn--blue-2" OnClick="btn_add" OnClientClick="return confirm('Are you Sure to Add?')" />
                        <%} %>
